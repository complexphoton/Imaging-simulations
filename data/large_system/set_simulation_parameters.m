...
W = 600; % system width (micron) 
L = 400; % system length (micron)
...
weak_diam = 0.7;
target_density = 0.002; % number of scatterers per unit area (micron^2)
weak_density = 0.25;
...
n_wavelengths_per_job = 2; % number of wavelengths per job
